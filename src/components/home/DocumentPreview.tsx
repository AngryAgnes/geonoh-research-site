  ...
  return (
    <section className="border-t border-slate-200 py-12">
      <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr]">
        <div>
          <p className="text-sm font-semibold uppercase text-slate-500">Research library</p>
          <h2 className="mt-3 text-2xl font-semibold text-slate-950">Document preview</h2>
